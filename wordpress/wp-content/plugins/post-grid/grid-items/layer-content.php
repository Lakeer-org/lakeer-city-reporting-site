...
if ( ! defined('ABSPATH')) exit;  // if direct access
	...
	$html.='</div></a>'; // .layer-content
	
	$html.='<div class="layer-nav-icons row text-right mx-0 px-0 d-none">';
	
	$html.= '<div class="layer-nav-icon offset-8 col-1"><a href="' . get_permalink() . '" target="_blank"><i class="fas fa-bars"></i></a></div>';
	$html.= '<div class="layer-nav-icon col-1"><a href="#"><i class="fas fa-reply fa-flip-horizontal"></i></a></div>';
	
	$html.= '</div>'; //.layer.nav-icons
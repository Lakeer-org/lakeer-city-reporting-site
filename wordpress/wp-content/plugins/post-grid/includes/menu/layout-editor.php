...
if(empty($_POST['post_grid_hidden']))
	...
	{	
		...
		if(wp_verify_nonce( $nonce, 'nonce_layout_content' ) && $_POST['post_grid_hidden'] == 'Y')  {
			...
			?>
			<div class="updated"><p><strong><?php _e('Something is not right.', 'post-grid' ); ?></strong></p></div>
...
<div class="wrap">
	...
	<div id="icon-tools" class="icon32"><br></div><?php echo "<h2>".post_grid_plugin_name.__(' - Layout Editor', 'post-grid')."</h2>";?>
                ...
                foreach($layout as $item_key=>$item_info){
                    ...
                    ?>
                		...
                		elseif($item_key=='issue_notes'){
                            ...
                            ?>
                            Some notes for the issue will come here from the custom fields...
                            <?php
                            }
	...
	<br />
								...
								elseif($item_key=='char_limit'){
										?>
                                        	...
                                        	<?php _e('Character limit:','post-grid' ); ?> <br />
